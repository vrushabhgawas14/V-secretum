...
V Secretum is a modern and secure password manager app designed to keep your credentials protected while providing a clean and simple user experience. The application uses advanced AES encryption to securely store passwords in encrypted form within the database. Encryption keys are dynamically generated using user specific identifiers which are unique for every user, adding an additional layer of security for every account.
